...
compare() {
	...
	initSequence=$(shuf -i 1-100 -n 30 | tr "\n" " ")
	...
	echo -e "sortedSequence: $sortedSequence"
	echo -e "pmergeSequenceCont1: $pmergeSequenceCont1"
	echo -e "pmergeSequenceCont2: $pmergeSequenceCont2"
