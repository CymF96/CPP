...
/*   Updated: 2025/01/14 11:49:54 by cofische         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string &inputName) : name(inputName), hit_points(10), energy_points(10), attack_damage(5) {
	std::cout << BOLD GREEN << name << RESET << " has been generated" << std::endl;
}

ClapTrap::~ClapTrap() {
	std::cout << RED BOLD << name << RESET << " has been destroy" << std::endl;
}
